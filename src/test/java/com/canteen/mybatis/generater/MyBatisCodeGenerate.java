package com.canteen.mybatis.generater;
...
public class MyBatisCodeGenerate {
    @Test
    public void codeGenerater() throws SQLException, IOException, InterruptedException, XMLParserException, InvalidConfigurationException {
        //MBG 执行过程中的警告信息
